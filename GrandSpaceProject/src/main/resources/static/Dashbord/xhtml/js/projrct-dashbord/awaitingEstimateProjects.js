document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("http://88.222.241.45:6070/api/project/projects/awaiting-estimates/count")
...
async function fetchProjects() {
    try {
        ...
        const response = await fetch('http://88.222.241.45:6070/api/project/awaiting-estimates-projects');
