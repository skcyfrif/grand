document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("http://88.222.241.45:6070/api/project/count-completed-projects-last-year")
...
async function fetchProjects() {
    try {
        ...
        const response = await fetch('http://88.222.241.45:6070/api/project/completed-projects-registered-last-year');
