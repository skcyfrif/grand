document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch("http://88.222.241.45:6070/api/project/count-wip-last-year")
...
async function fetchProjects() {
    try {
        ...
        const response = await fetch('http://88.222.241.45:6070/api/project/wip-projects-registered-last-year');
